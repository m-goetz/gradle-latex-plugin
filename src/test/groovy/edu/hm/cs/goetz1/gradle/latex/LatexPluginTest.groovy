...
public class LatexPluginTest {
	...
	public void latexPluginAddsBiberTask() {
		...
		assertTrue(taskDependsAnother(project.tasks.biber, project.tasks.pdflatexPreBuild))
	}
	...
	public void latexPluginAddsPdflatexTask() {
		...
		assertTrue(taskDependsAnother(project.tasks.pdflatex, project.tasks.biber))
	}

	private boolean taskDependsAnother(Task dependend, Task dependency) {
